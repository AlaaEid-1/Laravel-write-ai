        ...
        <main
            ...
            <form action="{{ route('register.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="full_name" name="name" value="{{ old('name') }}" placeholder="E.g. Julian Barnes"
                        required="" type="text">
                </div>
                @error('name')
                ...
                @enderror
                <div>
                    <label class="block font-ui-label text-ui-label text-on-surface mb-2" for="username">
                        Username
                    </label>
                ...
                <div>
                    ...
                    <input
                        class="w-full px-4 py-3 rounded-lg border border-outline-variant bg-surface focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all outline-none font-ui-label"
                        id="email" name="email" value="{{ old('email') }}" placeholder="julian@inkandpaper.com"
                        required="" type="email">
                </div>
                @error('email')
                    <span class="text-error text-sm">{{ $message }}</span>
            ...
            <footer class="mt-8 text-center">
                <p class="font-metadata text-metadata text-on-surface-variant">
                    ...
                    <a class="font-ui-label text-primary hover:underline ml-1" href="#">Log in</a>
                </p>
